...
class Veicolo 
{
	...
	public:
		Veicolo() {}
		Veicolo(int numeroRuote, int velocitaMassima, double prezzo, std::string marca, std::string carburante, std::string motorizzazione) : numeroRuote(numeroRuote), velocitaMassima(velocitaMassima), velocita(50), prezzo(prezzo), marca(marca), carburante(carburante), motorizzazione(motorizzazione) {}
		...
		std::string getCarburante() {return carburante;}
		
		std::string getMotorizzazione() {return motorizzazione;}
		
		void setNumeroRuote(int n) {numeroRuote = n;}
		
		void setVelocitaMassima(int n) {velocitaMassima = n;}
				
		void setPrezzo(double d) {prezzo = d;}
		
		void setMarca(std::string s) {marca = s;}
		
		void setCarburante(std::string s) {carburante = s;}
		
		void setMotorizzazione(std::string s) {motorizzazione = s;}
